...
import 'package:testpayment/streams/transactions.dart';
        ...
        children: [
          FlatButton.icon(
            label: Text(
              'Refund',
              textScaleFactor: 1.1,
              style: TextStyle(letterSpacing: 0.3, fontWeight: FontWeight.bold, color: Colors.red),
            ),
            icon: const Icon(
              Icons.bug_report,
          ...
          Material(
            ...
            child: FlatButton.icon(
              ...
              label: Text(
                'Buy',
                textScaleFactor: 1.1,
                style: TextStyle(letterSpacing: 0.3, fontWeight: FontWeight.bold, color: Colors.green),
              ),
              icon: const Icon(
                Icons.attach_money,
                color: Colors.green,
              ...
              onPressed: () async {
                return await showBuyDialog(
                  ...
                  buyDocument.setData(
                      {'currency': value[0], 'amount': amount, 'description': 'Charging ${value[0]}:$amount for buying...'});
                });
              },
            ),
          ),
