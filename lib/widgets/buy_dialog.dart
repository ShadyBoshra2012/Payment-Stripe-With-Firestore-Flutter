...
import 'package:testpayment/utilities/CommonFunctions.dart' show min, max, usd, defAmount;

import 'custom_slider.dart';

class BuyDialog extends StatefulWidget {
  BuyDialog({Key key, this.currencies, this.onCurrencyChange, this.onFinalAmount}) : super(key: key);
